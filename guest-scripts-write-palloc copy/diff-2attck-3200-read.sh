...
bank_pll -i 40000000000 -c 1 -a read -e 1 -m 320 -b 0xC0 -l 16 -s 1 -n 2 -A &  # attacker on data bank 0
pid2=$!

bank_pll -i 40000000000 -c 2 -a read -e 2 -m 320 -b 0xC0 -l 16 -s 2 -n 2 -A &  # attacker on data bank 0
pid3=$!
