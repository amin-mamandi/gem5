...
cpu_type = CPUTypes.TIMING if use_checkpoint else CPUTypes.ATOMIC
...
processor = SimpleProcessor(
    cpu_type=cpu_type, isa=ISA.RISCV, num_cores=4
)
...
kwargs = {
    ...
    "bootloader": BootloaderResource(
        local_path="/home/RTAS2025/resources-riscv/connor-bin"
    ),
...
if use_checkpoint:
    kwargs["checkpoint"] = Path("/home/RTAS2025/gem5/m5out/cpt.527434765732872") #69669472689432 5578212856076937

board.set_kernel_disk_workload(**kwargs)

simulator = Simulator(board=board)
print(f"Beginning simulation in {'run (with checkpoint)' if use_checkpoint else 'checkpoint creation'} mode!")
