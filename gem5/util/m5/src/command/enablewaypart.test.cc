...
void
test_m5_enablewaypart(uint64_t enable_value)
{
    test_enable_value = enable_value;
}

DispatchTable dt = { .m5_enablewaypart = &test_m5_enablewaypart };
