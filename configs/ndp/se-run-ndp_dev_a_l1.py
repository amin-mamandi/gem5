...
# Create CPU to L1 interconnect
system.l1bus = L2XBar()

# Connect NDP device to the CPU and L1D to NDP device
system.ndp_accel.cpu_side = system.cpu.dcache_port
system.l1bus.cpu_side_ports = system.ndp_accel.mem_side
system.cpu.dcache.cpu_side = system.l1bus.mem_side_ports
...
system.system_port = system.l1bus.cpu_side_ports
