...
from gem5.modules import filesystem
from gem5.modules import ruby
...
class EPISystemSE(m5.objects.System):
    ...
    def configure_caches(self, options):
        from gem5.modules.caches import L1I, L1D, WalkCache, L2, L3Slice
    ...
    def configure_memory(self, options):
        from gem5.modules.memory import create_memory_interface #HBM, HBM2, DDR4_2400_8x8
