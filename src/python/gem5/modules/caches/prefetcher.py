...
class AMPM_Object(m5.objects.AccessMapPatternMatching):
    def __init__(self, parameters, **kwargs):
        ...
        self.access_map_table_entries = parameters.get(
            "access_map_table_entries", "256"
        )
        # Associativity of the access map table
        self.access_map_table_assoc = parameters.get(
        ...
        self.offchip_memory_latency = parameters.get(
...
class Stride(m5.objects.StridePrefetcher):
    def __init__(self, parameters, **kwargs):
        ...
        self.confidence_counter_bits = parameters.get(
...
class Tagged(m5.objects.TaggedPrefetcher):
    def __init__(self, parameters, **kwargs):
        ...
        self.max_prefetch_requests_with_pending_translation = parameters.get(
        ...
        self.throttle_control_percentage = parameters.get(
...
class IndirectMemory(m5.objects.IndirectMemoryPrefetcher):
    def __init__(self, parameters, **kwargs):
        ...
        self.max_prefetch_distance = parameters.get(
            "max_prefetch_distance", 16
        )
        # Number of bits of the indirect counter
        self.num_indirect_counter_bits = parameters.get(
            "num_indirect_counter_bits", 3
        )
        ...
        self.stream_counter_threshold = parameters.get(
...
class SignaturePath(m5.objects.SignaturePathPrefetcher):
    def __init__(self, parameters, **kwargs):
        ...
        self.signature_table_entries = parameters.get(
        ...
        self.pattern_table_entries = parameters.get(
        ...
        self.strides_per_pattern_entry = parameters.get(
        ...
        self.prefetch_confidence_threshold = parameters.get(
            "prefetch_confidence_threshold", 0.5
        )
        # Minimum confidence to continue exploring lookahead entries
        self.lookahead_confidence_threshold = parameters.get(
...
class SignaturePath2(m5.objects.SignaturePathPrefetcherV2):
    def __init__(self, parameters, **kwargs):
        ...
        self.global_history_register_entries = parameters.get(
            "strides_per_pattern_entry", "8"
        )
...
class AMPM(m5.objects.AMPMPrefetcher):
    def __init__(self, parameters, **kwargs):
        super().__init__(ampm=AMPM_Object(parameters, **kwargs), **kwargs)
        # Latency for generated prefetches
        self.latency = parameters.get("latency", 1)
        # Maximum number of queued prefetches
        self.queue_size = parameters.get("queue_size", 32)
...
class IrregularStreamBuffer(m5.objects.IrregularStreamBufferPrefetcher):
    def __init__(self, parameters, **kwargs):
        ...
        self.training_unit_entries = parameters.get(
        ...
        self.prefetch_candidates_per_entry = parameters.get(
            "prefetch_candidates_per_entry", 16
        )
        # Associativity of the PS/SP AMCs
        self.address_map_cache_assoc = parameters.get(
            "address_map_cache_assoc", 128
        )
        # Number of entries of the PS/SP AMCs
        self.address_map_cache_entries = parameters.get(
...
class BOP(m5.objects.BOPPrefetcher):
    def __init__(self, parameters, **kwargs):
        ...
        self.negative_offsets_enable = parameters.get(
...
class SBOOE(m5.objects.SBOOEPrefetcher):
    def __init__(self, parameters, **kwargs):
        ...
        self.sequential_prefetchers = parameters.get(
            "sequential_prefetchers", 9
        )
...
class STeMS(m5.objects.STeMSPrefetcher):
    def __init__(self, parameters, **kwargs):
        ...
        # Memory covered by a hot zone
        self.spatial_region_size = parameters.get(
            "sequential_prefetchers", "2KiB"
        )
        # Number of entries in the active generation table
        self.active_generation_table_entries = parameters.get(
            "sequential_prefetchers", "64"
        )
        # Associativity of the active generation table
        self.active_generation_table_assoc = parameters.get(
            "sequential_prefetchers", 64
        )
        ...
        self.pattern_sequence_table_entries = parameters.get(
            "sequential_prefetchers", "16384"
        )
        # Associativity of the pattern sequence table
        self.pattern_sequence_table_assoc = parameters.get(
            "sequential_prefetchers", 16384
        )
        ...
        self.region_miss_order_buffer_entries = parameters.get(
            "sequential_prefetchers", 131072
        )
        # Add duplicate entries to RMOB
        self.add_duplicate_entries_to_rmob = parameters.get(
            "sequential_prefetchers", True
        )
        # Number of reconstruction entries
        self.reconstruction_entries = parameters.get(
            "sequential_prefetchers", 256
        )
...
class PIF(m5.objects.PIFPrefetcher):
    def __init__(self, parameters, **kwargs):
        ...
        self.prec_spatial_region_bits = parameters.get(
            "sequential_prefetchers", 2
        )
        # Number of subsequent addresses in the spatial region
        self.succ_spatial_region_bits = parameters.get(
            "sequential_prefetchers", 8
        )
        # Entries in the temp. compactor
        self.compactor_entries = parameters.get("sequential_prefetchers", 2)
        # Entries in the SAB
        self.stream_address_buffer_entries = parameters.get(
            "sequential_prefetchers", 7
        )
