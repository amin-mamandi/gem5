...
bank_pll -i 40000000000 -c 1 -a write -e 1 -m 320 -b 0xC0 -l 16 -s 1 -n 3 -A -x & # attacker on data bank 0
pid1=$!

bank_pll -i 40000000000 -c 2 -a write -e 2 -m 320 -b 0xC0 -l 16 -s 2 -n 3 -A -x & # attacker on data bank 0
pid2=$!

bank_pll -i 40000000000 -c 3 -a write -e 3 -m 320 -b 0xC0 -l 16 -s 3 -n 3 -A -x & # attacker on data bank 0
pid3=$!
