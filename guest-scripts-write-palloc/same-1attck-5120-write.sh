...
bank_pll -i 500000000000 -c 1 -a write -e 0 -m 1280 -b 0xC0 -l 16 -s 1 -n 1 -A &  # attacker on data bank 0
pid3=$!
...
bank_pll -i 500 -c 0 -a read -e 0 -m 5120 -b 0xC0 -l 16 -s 0 -n 1 &  # victim
pid4=$!
