...
# bank_pll -i 30000000000 -c 1 -a read -e 2 -m 1280 -b 0x80C0 -l 16 & # attacker on data bank 0
pid2=$!

bank_pll -i 4500000000000 -c 1 -a read -e 0 -m 320 -b 0x80C0 -l 16 -s 1 -n 1 -A -x & # attacker on data bank 0
pid3=$!
...
bank_pll -i 4500 -c 0 -a read -e 12 -m 2560 -b 0x80C0 -l 16 -s 0 -n 1 -x & # victim
pid4=$!
