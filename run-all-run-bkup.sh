...
CKPT_BASE_DIR="$PWD/ckpts-palloc"  # Modified to match your first script's structure
...
run_single_simulation() {
    ...
    ./run-bkup.sh $COMMON_PARAMS $bank_params --script-dir "$script_dir" --script "$script" $mshr_param $l2size_param &
    pid=$!    
